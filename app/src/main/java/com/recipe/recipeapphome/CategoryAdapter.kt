...
import com.recipe.recipeapphome.databinding.CategoryRvBinding
import com.recipe.recipeapphome.databinding.SearchRvBinding
...
class CategoryAdapter (var dataList: ArrayList<Recipe>,var context: Context):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       Glide.with(context).load(dataList.get(position).img).into(holder.binding.img)
        ...
        holder.binding.timetxt.text=temp[0]
